...
{request.status === 'open' && isOwner && (
<>
<div className="bg-blue-50 dark:bg-blue-900/30 border-2 border-blue-300 dark:border-blue-600 rounded-lg p-3 mb-3 text-center">
<span className="text-blue-700 dark:text-blue-300 font-semibold text-sm">
ℹ️ This is your request. You can close or delete it, but you can't fulfill it yourself.
</span>
</div>
